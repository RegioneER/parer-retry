...
/**
 * Client per ws rest con gestione automatica del retry e del fallback. Basato su
 * {@link RetryTemplate}.
 *
 * @author Snidero_L
 */
public class ParerRetryConfiguration {
     ...
     *
     * @param <R>      Risultato atteso
     * @param <E>      Eccezione per cui si effettua il retry
     * @param metodo   callback, ovvero metodo che deve essere eseguito
     * @param fallback fallback, ovvero metodo che deve essere eseguito in caso falliscano tutti i
     *                 tentativi di re-invio
     *
